...
def make_rps_inversion_result_plots():
    ...
    rps_atmos_result = Path(
        '/home/harsh/SpinorNagaraju/maps_1/stic/RPs_plots/inversions/full_stokes_5343/rps_stic_profiles_x_30_y_1_cycle_1_t_5_vl_3_vt_4_blos_3_atmos.nc'
    )

    rps_profs_result = Path(
        '/home/harsh/SpinorNagaraju/maps_1/stic/RPs_plots/inversions/full_stokes_5343/rps_stic_profiles_x_30_y_1_cycle_1_t_5_vl_3_vt_4_blos_3_profs.nc'
    )
    ...
    rps_plot_write_dir = Path(
        '/home/harsh/SpinorNagaraju/maps_1/stic/RPs_plots/inversions/full_stokes_5343'
    )
