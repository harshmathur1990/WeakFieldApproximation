...
def make_compare_plots():
    ...
    im10 = axs[1][0].imshow(fca['blong'][0, 2:, :, 123].T - fca['blong'][0, 2:, :, 131].T, cmap='gray', origin='lower')
    im11 = axs[1][1].imshow(fca['blong'][0, 2:, :, 102].T - fca['blong'][0, 2:, :, 123].T, cmap='gray', origin='lower')
    im12 = axs[1][2].imshow(fca['blong'][0, 2:, :, 50].T - fca['blong'][0, 2:, :, 102].T, cmap='gray', origin='lower')
    im13 = axs[1][3].imshow(magha.T - fca['blong'][0, 2:, :, 50].T, cmap='gray', origin='lower')
